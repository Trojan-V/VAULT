...
public final class ArtifactTest
{
	...
	//		Assertions.assertTrue(checkIfArtifactsAreUpgradable(),
	//		ARTIFACTS_NOT_UPGRADABLE_AT_BASE_LEVEL_ERROR_MESSAGE);
	//
	...
	//	{
	//		// Set the artifact level to the base level before testing, as otherwise testing upgrading wouldn't make
	//		sense.
	//		setArtifactsToLevel(ArtifactLevel.BASE);
	//		upgradeAllArtifacts();
	//		upgradeAllArtifacts();
	...
	//					scienceUpgradeCost, scienceAmountBeforeUpgrade, Currency.SCIENCE.getAmount(), artifact
	//					.getLevel()
	//				.name()));
	//		}
	//	}
