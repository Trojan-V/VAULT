 ...
 * <br>
 * Usually, these classes are controller classes that provide upgrading capabilities for their corresponding models.
 * These models have to implement the {@link UpgradableNew} interface.
 *
...
public interface IUpgrader<T extends UpgradableNew<E>, E>
{
	 ...
	 * <br>
	 * This method checks the constraints that need to be fulfilled to be able to upgrade the {@link UpgradableNew}
	 * to the next level.
	 *
