...
public interface EnergyConstants
{
	...
	interface Dodge
	{
		 ...
		 */
		@Constant
		String BASE_SPRITE_PATH = GameConstants.ASSETS_PATH + "energy/dodge_energyability.png";

		/**
		 * The path to the sprite of the improved sprite of the {@link DodgeAbility}.
		 */
		@Constant
		String IMPROVED_SPRITE_PATH = GameConstants.ASSETS_PATH + "energy/dodge_energyability.png";
	...
	interface Melee
	{
		 ...
		 */
		@Constant
		String BASE_SPRITE_PATH = GameConstants.ASSETS_PATH + "energy/melee_energyability.png";

		/**
		 * The path to the sprite of the improved sprite of the {@link MeleeAbility} .
		 */
		@Constant
		String IMPROVED_SPRITE_PATH = GameConstants.ASSETS_PATH + "energy/melee_energyability.png";
