...
public interface LoggingConstants
{
	...
	/**
	 * This subinterface contains logging constants related to the {@link me.vault.game.view.arena.ArenaDelegate}.
	 *
	 * @author Vincent Wolf, Lasse-Leander Hillen, Timothy Hoegen-Jupp, Alexander Goethel
	 * @version 1.0.0
	 * @see Artifact
	...
	interface ArenaDelegate
	{
		...
		/**
		 * Message pattern to print out that the {@link me.vault.game.view.arena.ArenaDelegate} couldn't be loaded.
		 */
		@Constant
		...
		/**
		 * Message pattern to print out that a {@link Figure} attacked another {@link Figure}.
		 */
		@Constant
