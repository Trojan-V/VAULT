package me.vault.game.utility.comparators;
 ...
 * @version 1.0.0
 * @see Timeline#createPriorityQueue()
 * @since 28.07.2024
 */
public class InitiativeComparator implements Comparator<Figure>
{
	...
	{
		return Integer.compare(figure.getStatistics().getDexterity().getInitiativePoints(), anotherFigure.getStatistics().getDexterity().getInitiativePoints());
	}
