...
public interface StringConstants
{
	 ...
	 */
	public static String tutorialIntroduction = "Hello dear player, first thank you for playing our little game. In " +
	...
	public static String tutorialCity = "The City is the main hub. At the top of the screen the current amount off " +
	                                    ...
	                                    "unlocked from the start. The command center is where one selects the " +
	                                    "mission" +
	...
	public static String tutorialFights = "When you encounter enemy`s on the mission-map you enter a fight. Fight in" +
	                                      " " +
	                                      ...
	                                      "defendant hostile can dodge the attack. If an attack lands the damage " +
	                                      "that" +
	                                      ...
	                                      "the attacker and the defender. If a troop is down to zero health it is " +
	                                      "out" +
	                                      " of combat.";
