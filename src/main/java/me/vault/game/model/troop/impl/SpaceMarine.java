...
import static me.vault.game.utility.constant.TroopConstants.SpaceMarine.SPACE_MARINE_STATISTIC;
...
public class SpaceMarine extends Troop
{
	...
	static
	{
		NAMES.put(TroopLevel.SINGLE_COMBATANT, TroopConstants.SpaceMarine.SINGLE_NAME);
		NAMES.put(TroopLevel.COUPLE, TroopConstants.SpaceMarine.COUPLE_NAME);
		NAMES.put(TroopLevel.SQUAD, TroopConstants.SpaceMarine.SQUAD_NAME);

		SPRITES.put(TroopLevel.SINGLE_COMBATANT, TroopConstants.SpaceMarine.SINGLE_SPRITE);
		SPRITES.put(TroopLevel.COUPLE, TroopConstants.SpaceMarine.COUPLE_SPRITE);
		SPRITES.put(TroopLevel.SQUAD, TroopConstants.SpaceMarine.SQUAD_SPRITE);

		UPGRADE_COSTS.put(TroopLevel.SINGLE_COMBATANT, TroopConstants.SpaceMarine.SINGLE_UPGRADE_COST);
		UPGRADE_COSTS.put(TroopLevel.COUPLE, TroopConstants.SpaceMarine.COUPLE_UPGRADE_COST);
		UPGRADE_COSTS.put(TroopLevel.SQUAD, TroopConstants.SpaceMarine.SQUAD_UPGRADE_COST);
