...
public enum CityBuildingLevel
{
	...
	public static CityBuildingLevel getNextHigherLevel (final CityBuildingLevel currentArtifactLevel)
	{
	...
	public static CityBuildingLevel getNextLowerLevel (final CityBuildingLevel level)
	{
