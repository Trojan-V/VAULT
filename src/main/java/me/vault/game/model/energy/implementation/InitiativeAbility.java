...
public final class InitiativeAbility extends EnergyAbility
{
	 ...
	 * {@link EnergyAbilityLevel} as key to denote which name corresponds to which {@link EnergyAbilityLevel}.
	 */
	 ...
	 * {@link EnergyAbilityLevel} as key to denote which sprite corresponds to which {@link EnergyAbilityLevel}.
	 */
	private static final Map<EnergyAbilityLevel, MetaDataImage> SPRITES;

	/**
	 * All possible modifier sets of the initiative energy ability are stored in this {@link Map}, with the {@link EnergyAbilityLevel} as
	 * key to denote which set of modifiers corresponds to which {@link EnergyAbilityLevel}.
	 */
	 ...
	 * {@link Map}, with the {@link EnergyAbilityLevel} as key to denote which set of upgrade costs corresponds to which {@link EnergyAbilityLevel}.
	 */
	...
	private static Map<EnergyAbilityLevel, CurrencyTransaction> initUpgradeCostsMap ()
	{
		...
		upgradeCostsMap.put(EnergyAbilityLevel.BASE, BASE_TO_IMPROVED_UPGRADE_COSTS);
		upgradeCostsMap.put(EnergyAbilityLevel.IMPROVED, IMPROVED_TO_NONE_UPGRADE_COSTS);
	...
	private static Map<EnergyAbilityLevel, String> initNamesMap ()
	{
		...
		namesMap.put(EnergyAbilityLevel.BASE, Initiative.BASE_NAME);
		namesMap.put(EnergyAbilityLevel.IMPROVED, Initiative.IMPROVED_NAME);
	...
	private static Map<EnergyAbilityLevel, MetaDataImage> initSpritesMap ()
	{
		...
		spritesMap.put(EnergyAbilityLevel.BASE, ResourceLoader.loadImage(Initiative.BASE_SPRITE_PATH));
		spritesMap.put(EnergyAbilityLevel.IMPROVED, ResourceLoader.loadImage(Initiative.IMPROVED_SPRITE_PATH));
