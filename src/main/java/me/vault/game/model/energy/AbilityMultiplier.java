...
public class AbilityMultiplier
{
	...
	private void validate () throws InvalidAttributeModifierException
	{
		...
		{
			throw new InvalidAttributeModifierException(this.dodgeMultiplierProperty.get());
		}
		if (this.initiativeMultiplierProperty.get() <= 0)
		{
			throw new InvalidAttributeModifierException(this.initiativeMultiplierProperty.get());
		}
		if (this.meleeMultiplierProperty.get() <= 0)
		{
			throw new InvalidAttributeModifierException(this.meleeMultiplierProperty.get());
		}
	}
