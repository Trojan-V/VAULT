...
import me.vault.game.utility.comparators.InitiativeComparator;
 ...
 * <br>
 * The most important part here's the {@link Timeline#createPriorityQueue()} method, which returns a priority queue that determines which {@link Figure}
...
public class Timeline
{
	...
	/**
	 * The {@link MessageFormat} pattern, which is used, when the {@link Timeline#toString()} is
	 * called.
	 */
	 ...
	 * <br>
	 * This list is used every time {@link Timeline#createPriorityQueue()} is invoked to create a fresh priority queue for all {@link Figure}s that are
	...
	/**
	 * Creates a priority queue which contains all {@link Timeline#elements}.
	 * <br>
	 ...
	 *
	 * @return A priority queue which contains all {@link Timeline#elements}.
	 *
	 * @precondition The {@link Timeline#elements} exists.
	 * @postcondition The priority queue which contains all {@link Timeline#elements} is created.
	 */
	 ...
	 * {@link Timeline#TO_STRING_PATTERN}.
	 *
	 * @return A {@link String} which has been formatted in the {@link Timeline#TO_STRING_PATTERN}.
	 *
	 * @precondition The {@link Timeline#TO_STRING_PATTERN} is {@code != null}.
