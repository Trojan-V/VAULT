...
import me.vault.game.utility.exception.UndefinedArenaResultException;
...
public final class ArenaFinishedDialogDelegate
{
	 ...
	 */
	private static final String ARENA_FINISHED_DIALOG_FXML = "arena_finished_dialog.fxml";
	...
	public static void show (final Mission mission, final Arena arena)
	{
		try
		{
			final FXMLLoader fxmlLoader = new FXMLLoader(ArenaFinishedDialogDelegate.class.getResource(ARENA_FINISHED_DIALOG_FXML));
