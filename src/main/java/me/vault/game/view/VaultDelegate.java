 ...
 * to these events by using callback methods for different events, for instance {@link VaultDelegate#onHelloButtonClick()}.
 * <br>
 * The registration of the controller automatically happens within the {@code main.fxml} file. The {@link VaultApplication} loads this {@code .fxml}
 * file and therefore the link between the application adn the corresponding controller is created.
 *
 * @author Vincent Wolf
 * @version 1.0.0
