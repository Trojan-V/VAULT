...
public enum ConsoleColor
{
    ...
    /**
     * The value of the console color. This value gets assigned as soon as an enum entry has been called,
     * as the constructor is invoked automatically as soon as someone uses an entry from the enum.
     */
