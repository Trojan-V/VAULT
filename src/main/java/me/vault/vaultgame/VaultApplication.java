...
public class VaultApplication extends Application
{
	...
	{
		FXMLLoader fxmlLoader = new FXMLLoader(VaultApplication.class.getResource(MAIN_STYLESHEET_FILENAME));
		Scene scene = new Scene(fxmlLoader.load(), WINDOW_START_WIDTH, WINDOW_START_HEIGHT);
